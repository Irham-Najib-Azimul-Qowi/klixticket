...
func (h *TaxHandler) CreateTax(c *gin.Context) {
	...
	if err != nil {
		utils.ErrorResponse(c, http.StatusInternalServerError, "Failed to create tax", err.Error())
		return
	}
...
func (h *TaxHandler) GetAllTaxes(c *gin.Context) {
	...
	if err != nil {
		utils.ErrorResponse(c, http.StatusInternalServerError, "Failed to fetch taxes", err.Error())
		return
	}

	utils.SuccessResponse(c, http.StatusOK, "Taxes fetched successfully", taxes)
}

func (h *TaxHandler) GetActiveTaxes(c *gin.Context) {
	taxes, err := h.service.GetActiveTaxes(c.Request.Context())
	if err != nil {
		utils.ErrorResponse(c, http.StatusInternalServerError, "Failed to fetch active taxes", err.Error())
		return
	}

	utils.SuccessResponse(c, http.StatusOK, "Active taxes fetched successfully", taxes)
}
...
func (h *TaxHandler) UpdateTax(c *gin.Context) {
	...
	if err != nil {
		utils.ErrorResponse(c, http.StatusInternalServerError, "Failed to update tax", err.Error())
		return
	}
...
func (h *TaxHandler) DeleteTax(c *gin.Context) {
	...
	if err != nil {
		utils.ErrorResponse(c, http.StatusInternalServerError, "Failed to delete tax", err.Error())
		return
	}
