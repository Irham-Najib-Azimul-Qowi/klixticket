...
func SeedEvents(db *gorm.DB) error {
	...
	events := []models.Event{
		...
		},
		{
			...
			Description:   "Konferensi teknologi terbesar tahun ini. Diskusi panel, workshop eksklusif, dan networking networking bareng pemimpin industri digital.",
			Location:      "Convention Hall - Grand Astoria",
			StartDate:     time.Date(2026, 11, 20, 9, 0, 0, 0, now.Location()),
			EndDate:       time.Date(2026, 11, 21, 18, 0, 0, 0, now.Location()),
			BannerURL:     ptr("/uploads/images/events/tech.webp"),
			PublishStatus: "published",
			TicketTypes: []models.TicketType{
				{
					Name: "Early Bird", 
